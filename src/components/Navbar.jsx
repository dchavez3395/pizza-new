      ...
      <div className='bg-[#d1411e] px-8 py-4 lg:px-12 sticky top-0 flex z-[50] justify-between'>
        ...
        <div className='hidden lg:flex items-center gap-4 text-white pt-3'>
          ...
          <div className='flex flex-row group'>
            <div className='p-[10px] bg-white lg:h-[50px] h-[40px] w-[40px] lg:w-[50px] rounded-full'>
              <img src="https://raw.githubusercontent.com/dchavez3395/pizza-new/main/src/assets/telephone.png" alt="phone-img" className='h-[32px]w-[32px] transitions-theme group-hover:-rotate-[360deg] transition-all duration-[1000ms] ease-in-out cursor-pointer' />
            </div>
        ...
        <div className='pt-3'>
          <button type='button' onClick={onCartToggle} className='cursor-pointer'>
            <img src="https://raw.githubusercontent.com/dchavez3395/pizza-new/main/src/assets/cart.png" className='lg:h-[32px] h-[25px] w-[25px] lg:w-[32px]' alt="" />
